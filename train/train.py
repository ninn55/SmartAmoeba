...
def toTensorflowLite(model, x_test):
    ...
    open("./bin/model.tflite", "wb").write(tflite_model)
...
if __name__ == "__main__":
    ...
    try:
        call('rm -rf ./bin/modelCheckpoint/', shell=True)
    except:
        pass
    checkpointCallback = tf.keras.callbacks.ModelCheckpoint(\
                                filepath = "../bin/modelCheckpoint/", \
                                verbose = 1, \
